...
ALTER TABLE "homework_sets" ADD CONSTRAINT "homework_sets_created_by_users_id_fk"
...
ALTER TABLE "homework_submissions" ADD CONSTRAINT "homework_submissions_set_fk"
  FOREIGN KEY ("homework_set_id") REFERENCES "public"."homework_sets"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "homework_submissions" ADD CONSTRAINT "homework_submissions_session_fk"
  FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "homework_submissions" ADD CONSTRAINT "homework_submissions_student_fk"
